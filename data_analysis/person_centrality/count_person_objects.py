...
"""This script extracts all person objects, i.e., all cases where a person is a tail entity of a triple, from a given Wikidata dump and counts them.
This gives the counts for incoming claims per person entity, which is later used in the script 'summarize_in_and_outdegrees.py'."""
