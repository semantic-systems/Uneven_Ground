...
"""This script is used to summarize the counts for incominng and outgoing claims for each person in a pre-extracted selection of person entities from the Wikidata knowledge graph.
Note that due to the computational load, the counting of the incoming claims is previously done in a separate script: 'count_person_objects.py'."""
